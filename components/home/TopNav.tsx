        ...
        >
          <div className="flex flex-col gap-4 cursor-pointer">
            ...
            >
              <img
                src={
                  "https://storage.googleapis.com/nyxassets/assets/images/home/ImageProduct.png"
                }
                alt="image"
            ...
            >
              <img
                ...
                src={
                  "https://storage.googleapis.com/nyxassets/assets/images/home/VideoProduct.png"
                }
                alt="image"
                loading="lazy"
                decoding="async"
            ...
            >
              <img
                className="w-[35px] md:w-[2rem] image"
                src={
                  "https://storage.googleapis.com/nyxassets/assets/images/home/CampulseProduct.png"
                }
                alt="image"
                loading="lazy"
                decoding="async"
            ...
            >
              <img
                className="w-[26px] md:w-[1.5rem] image"
                src={
                  "https://storage.googleapis.com/nyxassets/assets/images/home/LyricsProduct.png"
                }
                alt="image"
                loading="lazy"
                decoding="async"
