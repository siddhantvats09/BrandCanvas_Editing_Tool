...
function BgColorButton({
  ...
  return (
    <div className="inline-block relative z-10" ref={ref}>
      ...
      >
        <div className="text-xs text-[#FFFFFF] w-[70px] h-[30px] bg-[#1D1138] rounded-t-xl flex items-center justify-center">
          Add New
        </div>

        <div className="w-[70px] h-[40px] bg-[#6F559A] rounded-b-xl flex justify-center items-center p-3">
