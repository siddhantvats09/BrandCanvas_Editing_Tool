...
import "./header.css";
import { ARTIST_MENU, verifyJWTToken, USER_MENU } from "@/utils/utils";
...
function Header({ header_bg = "" }: { header_bg?: string }) {
  ...
  return (
    <>
      <nav
        className={`text-white px-2 sm:px-4 pb-4 w-full z-20 top-0 left-0 fixed ${
          stickyNav
            ? "header_bg_sticky"
            : header_bg
              ? "bg-transparent"
            ...
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              ...
              <li>
                <Link
                  href="/artist"
                  className={`block ${
                    path === "artist" ? "text-amber-500 cursor-pointer" : ""
            ...
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              ...
              <li>
                <span
                  ...
                  className={`block ${
                    path === "distribute" ? "text-amber-500 cursor-pointer" : ""
                  } dark:hover:text-white md:hover:text-amber-500 text-md md:p-0 pl-3 pr-4 py-2 cursor-pointer`}
                >
                  Distribute
                </span>
              ...
              <li>
                <span
                  ...
                  className={`block ${
                    path === "refer" ? "text-amber-500 cursor-pointer" : ""
                  } dark:hover:text-white md:hover:text-amber-500 text-md md:p-0 pl-3 pr-4 py-2 cursor-pointer`}
                >
                  Refer & Earn
                </span>
              ...
              <li>
                <span
                  ...
                  className={`block ${
                    path === "support" ? "text-amber-500 cursor-pointer" : ""
                  } dark:hover:text-white md:hover:text-amber-500 text-md md:p-0 pl-3 pr-4 py-2 cursor-pointer`}
                >
                  Support
                </span>
              ...
              <li>
                <span
                  ...
                  className={`block ${
                    path === "cart" ? "text-amber-500 cursor-pointer" : ""
                  } dark:hover:text-white md:hover:text-amber-500 text-md md:p-0 pl-3 pr-4 py-2 cursor-pointer`}
                >
                  Cart
                </span>
              ...
              <li>
                <Link
                  href="/experts"
                  className={`block ${
                    path === "experts" ? "text-amber-500 cursor-pointer" : ""
                  } dark:hover:text-white md:hover:text-amber-500 text-md md:p-0 pl-3 pr-4 py-2 cursor-pointer`}
                >
                  Experts
                </Link>
              ...
              <li>
                <button
                  ...
                  className={`block ${
                    path === "apphome/login" ? "text-amber-500 cursor-pointer" : ""
                  } dark:hover:text-white md:hover:text-amber-500 text-md md:p-0 pl-3 pr-4 py-2 cursor-pointer`}
                >
                  Logout
                </button>
