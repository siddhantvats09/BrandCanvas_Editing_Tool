...
export const HIW_MUSIC = [
  ...
  },
  {
    ...
    content:
      "Access your songs’ performance trends on your profile and claim your royalties every 6 months.",
    icon: hiw3,
    is_active: false,
  },
  {
...
export const HIW = [
  {
    ...
    content4:
      " Instrumentation: The choice of instruments and their arrangement can contribute to a song's emotional appeal. For instance, the use of acoustic instruments might create a more intimate and emotional atmosphere, while electronic elements can evoke a different set of emotions.  ",
    content5:
  ...
  },
  {
    ...
    content2:
      "Instrument Arrangement: The arrangement of acoustic instruments and how they interact with each other and other elements of the song is crucial. It can influence the perceived acoustic presence. ",
    content3:
  ...
  },
  {
    ...
    content2:
      "Rhythmic Patterns: Complex and rhythmic patterns, such as driving drumbeats or syncopated rhythms, can contribute to the song's energy level. ",
    content3:
  ...
  },
  {
    ...
    content4:
      "Structure: The song's structure, including the presence of instrumental breaks, build-ups, and drops, can affect danceability. Songs with well-defined structural elements often create opportunities for choreographed dance moves.  ",
    content5:
  ...
  },
  {
    ...
    content4:
      "Perceived Loudness: Perceived loudness is not solely determined by the actual volume level but also by the frequency content, compression, and limiting applied to the audio. Some songs may sound louder than others even if they have similar peak volume levels. ",
    content5:
...
export const HIW_ARTISTS = [
  ...
  },
  {
    ...
    content:
      "We also support content creators with funding and production of their content. Just reach out to the team with your concept and we’ll take care of it, followed by steps to release & sell shares",
    icon: ahiw5,
    is_active: false,
  },
];
...
export const CORE_VALUES = [
  ...
  },
  {
    ...
    content:
      'The truth will set you free. "Rather than love, than money, than fame, give me the truth." ― Henry David Thoreau, Walden.',
    icon: core_value4,
  },
  {
    title: "Take The Lead",
