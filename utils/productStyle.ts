...
export const budgetSelect:StylesConfig ={
  ...
  option: (styles, { isFocused, isSelected }) => ({
    ...
    cursor: "pointer",
    "&:hover": {
      background:isSelected ? "#5e32ff": "#192f73",
      color:"#FFCB54" // Change color on hover
    },
  }),
  menu: (base) => ({
    ...base,
...
export const assetSortStyle: StylesConfig = {
  ...
  menu: (baseStyles) => ({
    ...baseStyles,
    backgroundColor: "#28134B", // Set the background color of the menu to red
  }),
  ...
  option: (baseStyles, { isFocused, isSelected }) => ({
    ...baseStyles,
    backgroundColor: isFocused ? "#28134B" : "#20133D", // Set the background color of options
...
export const ruleDropDown: StylesConfig = {
  ...
  option: (baseStyles, { isFocused, isSelected }) => ({
    ...baseStyles,
    backgroundColor: isFocused ? "#3B236F" : "#20133D", // Set the background color of options
    color: "white", // Adjust text color for readability
  }),
  placeholder: (provided) => ({
    ...provided,
